...
class _Loading<T> implements TransferState<T> {
  const _Loading();
...
class _Success<T> implements TransferState<T> {
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $TransferStateCopyWith<T, $Res> {
...
class _Error<T> implements TransferState<T> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Error<T>&&(identical(other.apiErrorModel, apiErrorModel) || other.apiErrorModel == apiErrorModel));
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $TransferStateCopyWith<T, $Res> {
