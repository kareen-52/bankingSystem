...
import 'package:banking_system/features/admin_home_screen/admin_home_screen.dart';
...
import '../../features/employee_home_screen/employee_home_screen.dart';
  ...
  Route? generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case Routes.searchAccount:
        return MaterialPageRoute(
          builder: (_) =>
              BlocProvider(create: (context) => getIt<SearchAccountCubit>()),
        );
      default:
        return null;
    }
